...
public class ItemSentientJavelin extends ItemJavelinSE implements ISpartanWillWeapon {
    ...
    public ItemSentientJavelin() {
        ...
        this.damageMultiplier = ConfigHandler.damageMultiplierJavelin;
        this.baseAttackDamage = Math.max(0.5F, this.materialEx.getAttackDamage() * this.damageMultiplier + ConfigHandler.damageBaseJavelin - 1.0F);
        this.baseAttackSpeed = ConfigHandler.meleeSpeedJavelin;
    }
