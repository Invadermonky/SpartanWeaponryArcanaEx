...
import com.invadermonky.spartanweaponryarcanaex.items.base.ItemScytheSE;
...
public class ItemSentientScythe extends ItemScytheSE implements ISpartanWillWeapon {
    ...
    public ItemSentientScythe() {
        ...
        this.damageMultiplier = ConfigHandler.damageMultiplierScythe;
        this.baseAttackDamage = Math.max(0.5F, this.materialEx.getAttackDamage() * this.damageMultiplier + ConfigHandler.damageBaseScythe - 1.0F);
        this.baseAttackSpeed = ConfigHandler.speedScythe;
    }
