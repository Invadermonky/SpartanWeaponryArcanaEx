...
import com.invadermonky.spartanweaponryarcanaex.items.base.ItemLanceSE;
...
public class ItemSentientLance extends ItemLanceSE implements ISpartanWillWeapon {
    ...
    public ItemSentientLance() {
        ...
        this.damageMultiplier = ConfigHandler.damageMultiplierLance;
        this.baseAttackDamage = Math.max(0.5F, this.materialEx.getAttackDamage() * this.damageMultiplier + ConfigHandler.damageBaseLance - 1.0F);
        this.baseAttackSpeed = ConfigHandler.speedLance;
    }
