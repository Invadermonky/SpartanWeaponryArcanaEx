...
public class ItemSentientGlaive extends ItemGlaiveSE implements ISpartanWillWeapon {
    ...
    public ItemSentientGlaive() {
        ...
        this.baseAttackDamage = Math.max(0.5F, this.materialEx.getAttackDamage() * this.damageMultiplier + ConfigHandler.damageBaseGlaive - 1.0F);
