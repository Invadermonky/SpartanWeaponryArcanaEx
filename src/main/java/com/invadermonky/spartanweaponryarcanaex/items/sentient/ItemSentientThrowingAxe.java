...
import com.invadermonky.spartanweaponryarcanaex.items.base.ItemThrowingAxeSE;
...
public class ItemSentientThrowingAxe extends ItemThrowingAxeSE implements ISpartanWillWeapon {
    ...
    public ItemSentientThrowingAxe() {
        ...
        this.baseAttackDamage = Math.max(0.5F, this.materialEx.getAttackDamage() * this.damageMultiplier + ConfigHandler.damageBaseThrowingAxe - 1.0F);
        this.baseAttackSpeed = ConfigHandler.meleeSpeedThrowingAxe;
    }
