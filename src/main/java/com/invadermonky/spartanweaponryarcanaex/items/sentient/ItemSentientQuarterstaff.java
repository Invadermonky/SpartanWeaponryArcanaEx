...
import com.invadermonky.spartanweaponryarcanaex.items.base.ItemQuarterstaffSE;
...
public class ItemSentientQuarterstaff extends ItemQuarterstaffSE implements ISpartanWillWeapon {
    ...
    public ItemSentientQuarterstaff() {
        ...
        this.damageMultiplier = ConfigHandler.damageMultiplierQuarterstaff;
        this.baseAttackDamage = Math.max(0.5F, this.materialEx.getAttackDamage() * this.damageMultiplier + ConfigHandler.damageBaseQuarterstaff - 1.0F);
        this.baseAttackSpeed = ConfigHandler.speedQuarterstaff;
    }
