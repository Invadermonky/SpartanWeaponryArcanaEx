...
import com.invadermonky.spartanweaponryarcanaex.items.base.ItemRapierSE;
...
public class ItemSentientRapier extends ItemRapierSE implements ISpartanWillWeapon {
    ...
    public ItemSentientRapier() {
        ...
        this.damageMultiplier = ConfigHandler.damageMultiplierRapier;
        this.baseAttackDamage = Math.max(0.5F, this.materialEx.getAttackDamage() * this.damageMultiplier + ConfigHandler.damageBaseRapier - 1.0F);
        this.baseAttackSpeed = ConfigHandler.speedRapier;
    }
