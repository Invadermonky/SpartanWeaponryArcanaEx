...
import com.invadermonky.spartanweaponryarcanaex.items.base.ItemMaceSE;
...
public class ItemSentientMace extends ItemMaceSE implements ISpartanWillWeapon {
    ...
    public ItemSentientMace() {
        ...
        this.damageMultiplier = ConfigHandler.damageMultiplierMace;
        this.baseAttackDamage = Math.max(0.5F, this.materialEx.getAttackDamage() * this.damageMultiplier + ConfigHandler.damageBaseMace - 1.0F);
        this.baseAttackSpeed = ConfigHandler.speedMace;
    }
