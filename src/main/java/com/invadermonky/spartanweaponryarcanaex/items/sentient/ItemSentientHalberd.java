...
import com.invadermonky.spartanweaponryarcanaex.items.base.ItemHalberdSE;
...
public class ItemSentientHalberd extends ItemHalberdSE implements ISpartanWillWeapon {
    ...
    public ItemSentientHalberd() {
        ...
        this.damageMultiplier = ConfigHandler.damageMultiplierHalberd;
        this.baseAttackDamage = Math.max(0.5F, this.materialEx.getAttackDamage() * this.damageMultiplier + ConfigHandler.damageBaseHalberd - 1.0F);
        this.baseAttackSpeed = ConfigHandler.speedHalberd;
    }
