...
public class ItemSentientThrowingKnife extends ItemThrowingKnifeSE implements ISpartanWillWeapon {
    protected final double baseAttackDamage;
    protected final double damageMultiplier;
    protected final double baseAttackSpeed;

    public ItemSentientThrowingKnife() {
        ...
        this.damageMultiplier = ConfigHandler.damageMultiplierThrowingKnife;
        this.baseAttackDamage = Math.max(0.5F, this.materialEx.getAttackDamage() * this.damageMultiplier + ConfigHandler.damageBaseThrowingKnife - 1.0F);
    ...
    public double getBonusDamageMultiplier() {
        return MathHelper.clamp(this.getDamageMultiplier(), 0, 1);
    }
}
