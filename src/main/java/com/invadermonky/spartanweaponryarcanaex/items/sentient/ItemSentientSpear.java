...
public class ItemSentientSpear extends ItemSpearSE implements ISpartanWillWeapon {
    ...
    public ItemSentientSpear() {
        ...
        this.damageMultiplier = ConfigHandler.damageMultiplierSpear;
        this.baseAttackDamage = Math.max(0.5F, this.materialEx.getAttackDamage() * this.damageMultiplier + ConfigHandler.damageBaseSpear - 1.0F);
        this.baseAttackSpeed = ConfigHandler.speedSpear;
    }
