...
import com.invadermonky.spartanweaponryarcanaex.items.base.ItemPikeSE;
...
public class ItemSentientPike extends ItemPikeSE implements ISpartanWillWeapon {
    ...
    public ItemSentientPike() {
        ...
        this.damageMultiplier = ConfigHandler.damageMultiplierPike;
        this.baseAttackDamage = Math.max(0.5F, this.materialEx.getAttackDamage() * this.damageMultiplier + ConfigHandler.damageBasePike - 1.0F);
        this.baseAttackSpeed = ConfigHandler.speedPike;
    }
