...
import com.invadermonky.spartanweaponryarcanaex.items.base.ItemHammerSE;
...
public class ItemSentientHammer extends ItemHammerSE implements ISpartanWillWeapon {
    ...
    public ItemSentientHammer() {
        ...
        this.damageMultiplier = ConfigHandler.damageMultiplierHammer;
        this.baseAttackDamage = Math.max(0.5F, this.materialEx.getAttackDamage() * this.damageMultiplier + ConfigHandler.damageBaseHammer - 1.0F);
        this.baseAttackSpeed = ConfigHandler.speedHammer;
    }
