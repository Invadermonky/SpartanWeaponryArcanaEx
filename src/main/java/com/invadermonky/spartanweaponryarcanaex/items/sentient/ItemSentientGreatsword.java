...
import com.invadermonky.spartanweaponryarcanaex.items.base.ItemGreatswordSE;
...
public class ItemSentientGreatsword extends ItemGreatswordSE implements ISpartanWillWeapon {
    ...
    public ItemSentientGreatsword() {
        ...
        this.damageMultiplier = ConfigHandler.damageMultiplierGreatsword;
        this.baseAttackDamage = Math.max(0.5F, this.materialEx.getAttackDamage() * this.damageMultiplier + ConfigHandler.damageBaseGreatsword - 1.0F);
        this.baseAttackSpeed = ConfigHandler.speedGreatsword;
    }
