...
import com.invadermonky.spartanweaponryarcanaex.items.base.ItemLongswordSE;
...
public class ItemSentientLongsword extends ItemLongswordSE implements ISpartanWillWeapon {
    protected final double baseAttackDamage;
    protected final double damageMultiplier;
    protected final double baseAttackSpeed;

    public ItemSentientLongsword() {
        ...
        this.damageMultiplier = ConfigHandler.damageMultiplierLongsword;
        this.baseAttackDamage = Math.max(0.5F, this.materialEx.getAttackDamage() * this.damageMultiplier + ConfigHandler.damageBaseLongsword - 1.0F);
        this.baseAttackSpeed = ConfigHandler.speedLongsword;
    }
