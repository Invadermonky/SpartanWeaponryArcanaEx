...
public class ItemSentientDagger extends ItemDaggerSE implements ISpartanWillWeapon {
    ...
    public ItemSentientDagger() {
        ...
        this.damageMultiplier = ConfigHandler.damageMultiplierDagger;
        this.baseAttackDamage = Math.max(0.5F, this.materialEx.getAttackDamage() * this.damageMultiplier + ConfigHandler.damageBaseDagger - 1.0F);
