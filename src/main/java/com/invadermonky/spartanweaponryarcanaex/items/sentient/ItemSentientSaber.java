...
public class ItemSentientSaber extends ItemSaberSE implements ISpartanWillWeapon {
    ...
    public ItemSentientSaber() {
        ...
        this.damageMultiplier = ConfigHandler.damageMultiplierSaber;
        this.baseAttackDamage = Math.max(0.5F, this.materialEx.getAttackDamage() * this.damageMultiplier + ConfigHandler.damageBaseSaber - 1.0F);
        this.baseAttackSpeed = ConfigHandler.speedSaber;
    }
