...
import com.invadermonky.spartanweaponryarcanaex.items.base.ItemWarhammerSE;
...
public class ItemSentientWarhammer extends ItemWarhammerSE implements ISpartanWillWeapon {
    protected final double baseAttackDamage;
    protected final double damageMultiplier;
    protected final double baseAttackSpeed;

    public ItemSentientWarhammer() {
        ...
        this.damageMultiplier = ConfigHandler.damageMultiplierWarhammer;
        this.baseAttackDamage = Math.max(0.5F, this.materialEx.getAttackDamage() * this.damageMultiplier + ConfigHandler.damageBaseWarhammer - 1.0F);
        this.baseAttackSpeed = ConfigHandler.speedWarhammer;
    }
