...
public class ItemGreatswordSE extends ItemGreatsword {
    protected boolean doReequip = true;

    public ItemGreatswordSE(String materialName, ToolMaterialEx material) {
        super("greatsword_" + materialName, SpartanWeaponryArcanaEx.MOD_ID, material);
    }
