...
public class ItemQuarterstaffSE extends ItemQuarterstaff {
    protected boolean doReequip = true;

    public ItemQuarterstaffSE(String materialName, ToolMaterialEx material) {
        super("quarterstaff_" + materialName, SpartanWeaponryArcanaEx.MOD_ID, material);
    }
