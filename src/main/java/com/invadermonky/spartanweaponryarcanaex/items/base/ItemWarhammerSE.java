...
public class ItemWarhammerSE extends ItemWarhammer {
    protected boolean doReequip = true;

    public ItemWarhammerSE(String materialName, ToolMaterialEx material) {
        super("warhammer_" + materialName, SpartanWeaponryArcanaEx.MOD_ID, material);
