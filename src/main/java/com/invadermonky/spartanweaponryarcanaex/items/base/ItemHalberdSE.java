...
public class ItemHalberdSE extends ItemHalberd {
    protected boolean doReequip = true;

    public ItemHalberdSE(String materialName, ToolMaterialEx material) {
        super("halberd_" + materialName, SpartanWeaponryArcanaEx.MOD_ID, material);
    }
