...
public class ItemLongswordSE extends ItemLongsword {
    protected boolean doReequip = true;

    public ItemLongswordSE(String materialName, ToolMaterialEx material) {
        super("longsword_" + materialName, SpartanWeaponryArcanaEx.MOD_ID, material);
    }
