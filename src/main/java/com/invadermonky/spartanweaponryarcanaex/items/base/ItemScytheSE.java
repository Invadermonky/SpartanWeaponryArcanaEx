...
public class ItemScytheSE extends ItemScythe {
    protected boolean doReequip = true;

    public ItemScytheSE(String materialName, ToolMaterialEx material) {
        super("scythe_" + materialName, SpartanWeaponryArcanaEx.MOD_ID, material);
    }
