...
public class ItemCrystalLongbow extends ItemLongbowSE implements CrystalPropertyItem, ChargedCrystalToolBase {
    public ItemCrystalLongbow(String unlocName, ToolMaterialEx material, IWeaponCallback callback) {
    ...
    public Item getInertVariant() {
        return ModItemsSE.crystal_longbow;
    }
