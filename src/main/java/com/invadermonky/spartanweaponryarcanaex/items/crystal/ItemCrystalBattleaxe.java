...
public class ItemCrystalBattleaxe extends ItemBattleaxeSE implements CrystalPropertyItem, ChargedCrystalToolBase, ISharpenableCrystalWeapon {
    public ItemCrystalBattleaxe(String unlocName, ToolMaterialEx material) {
    ...
    public Item getInertVariant() {
        return ModItemsSE.crystal_battleaxe;
    }
