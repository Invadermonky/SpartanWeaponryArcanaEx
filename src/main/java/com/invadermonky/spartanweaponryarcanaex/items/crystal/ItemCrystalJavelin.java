...
public class ItemCrystalJavelin extends ItemJavelinSE implements CrystalPropertyItem, ChargedCrystalToolBase, ISharpenableCrystalWeapon {
    public ItemCrystalJavelin(String unlocName, ToolMaterialEx material) {
    ...
    public Item getInertVariant() {
        return ModItemsSE.crystal_javelin;
    }
