...
public class ItemCrystalQuarterstaff extends ItemQuarterstaffSE implements CrystalPropertyItem, ChargedCrystalToolBase, ISharpenableCrystalWeapon {
    public ItemCrystalQuarterstaff(String unlocName, ToolMaterialEx material) {
    ...
    public Item getInertVariant() {
        return ModItemsSE.crystal_quarterstaff;
    }
