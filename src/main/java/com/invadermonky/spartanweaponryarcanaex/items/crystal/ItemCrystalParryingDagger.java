...
public class ItemCrystalParryingDagger extends ItemParryingDaggerSE implements CrystalPropertyItem, ChargedCrystalToolBase, ISharpenableCrystalWeapon {
    public ItemCrystalParryingDagger(String unlocName, ToolMaterialEx material) {
    ...
    public Item getInertVariant() {
        return ModItemsSE.crystal_parrying_dagger;
    }
