...
public class ItemCrystalLongsword extends ItemLongswordSE implements CrystalPropertyItem, ChargedCrystalToolBase, ISharpenableCrystalWeapon {
    public ItemCrystalLongsword(String unlocName, ToolMaterialEx material) {
    ...
    public Item getInertVariant() {
        return ModItemsSE.crystal_longsword;
    }
