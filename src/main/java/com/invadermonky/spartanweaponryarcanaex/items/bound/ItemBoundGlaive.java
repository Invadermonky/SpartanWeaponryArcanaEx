...
import com.invadermonky.spartanweaponryarcanaex.items.base.ItemGlaiveSE;
...
public class ItemBoundGlaive extends ItemGlaiveSE implements ISpartanBoundWeapon {
    protected final double baseAttackDamage;
    protected final double baseAttackSpeed;

    public ItemBoundGlaive() {
        ...
        this.baseAttackDamage = Math.max(0.5F, this.materialEx.getAttackDamage() * ConfigHandler.damageMultiplierGlaive + ConfigHandler.damageBaseGlaive - 1.0F);
        this.baseAttackSpeed = ConfigHandler.speedGlaive;
    }
