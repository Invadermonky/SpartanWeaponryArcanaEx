...
public class ItemBoundWarhammer extends ItemWarhammerSE implements ISpartanBoundWeapon {
    protected final double baseAttackDamage;
    protected final double baseAttackSpeed;
    protected float directAttackDamage;

    public ItemBoundWarhammer() {
        ...
        this.baseAttackDamage = Math.max(0.5F, this.materialEx.getAttackDamage() * ConfigHandler.damageMultiplierWarhammer + ConfigHandler.damageBaseWarhammer - 1.0F);
