...
public class ItemBoundQuarterstaff extends ItemQuarterstaffSE implements ISpartanBoundWeapon {
    protected final double baseAttackDamage;
    protected final double baseAttackSpeed;
    protected float directAttackDamage;

    public ItemBoundQuarterstaff() {
        ...
        this.baseAttackDamage = Math.max(0.5F, this.materialEx.getAttackDamage() * ConfigHandler.damageMultiplierQuarterstaff + ConfigHandler.damageBaseQuarterstaff - 1.0F);
