...
public class ItemBoundParryingDagger extends ItemParryingDaggerSE implements ISpartanBoundWeapon {
    protected final double baseAttackDamage;
    protected final double baseAttackSpeed;
    protected float directAttackDamage;

    public ItemBoundParryingDagger() {
        ...
        this.baseAttackDamage = Math.max(0.5F, this.materialEx.getAttackDamage() * ConfigHandler.damageMultiplierParryingDagger + ConfigHandler.damageBaseParryingDagger - 1.0F);
