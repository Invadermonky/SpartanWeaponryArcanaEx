...
public class ItemBoundPike extends ItemPikeSE implements ISpartanBoundWeapon {
    protected final double baseAttackDamage;
    protected final double baseAttackSpeed;

    public ItemBoundPike() {
        ...
        this.baseAttackDamage = Math.max(0.5F, this.materialEx.getAttackDamage() * ConfigHandler.damageMultiplierPike + ConfigHandler.damageBasePike - 1.0F);
