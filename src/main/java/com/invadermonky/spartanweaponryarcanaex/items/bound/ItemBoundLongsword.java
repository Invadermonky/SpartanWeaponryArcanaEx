...
public class ItemBoundLongsword extends ItemLongswordSE implements ISpartanBoundWeapon {
    protected final double baseAttackDamage;
    protected final double baseAttackSpeed;

    public ItemBoundLongsword() {
        ...
        this.baseAttackDamage = Math.max(0.5F, this.materialEx.getAttackDamage() * ConfigHandler.damageMultiplierLongsword + ConfigHandler.damageBaseLongsword - 1.0F);
