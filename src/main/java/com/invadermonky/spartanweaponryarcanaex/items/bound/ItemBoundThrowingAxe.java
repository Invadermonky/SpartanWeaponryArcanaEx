...
public class ItemBoundThrowingAxe extends ItemThrowingAxeSE implements ISpartanBoundWeapon {
    protected final double baseAttackDamage;
    protected final double baseAttackSpeed;

    public ItemBoundThrowingAxe() {
        ...
        this.baseAttackDamage = Math.max(0.5F, this.materialEx.getAttackDamage() * ConfigHandler.damageMultiplierThrowingAxe + ConfigHandler.damageBaseThrowingAxe - 1.0F);
