...
public class ItemBoundGreatsword extends ItemGreatswordSE implements ISpartanBoundWeapon {
    protected final double baseAttackDamage;
    protected final double baseAttackSpeed;
    protected float directAttackDamage;

    public ItemBoundGreatsword() {
        ...
        this.baseAttackDamage = Math.max(0.5F, this.materialEx.getAttackDamage() * ConfigHandler.damageMultiplierGreatsword + ConfigHandler.damageBaseGreatsword - 1.0F);
