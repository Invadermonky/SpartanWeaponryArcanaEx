...
public class ItemBoundHalberd extends ItemHalberdSE implements ISpartanBoundWeapon {
    protected final double baseAttackDamage;
    protected final double baseAttackSpeed;

    public ItemBoundHalberd() {
        ...
        this.baseAttackDamage = Math.max(0.5F, this.materialEx.getAttackDamage() * ConfigHandler.damageMultiplierHalberd + ConfigHandler.damageBaseHalberd - 1.0F);
