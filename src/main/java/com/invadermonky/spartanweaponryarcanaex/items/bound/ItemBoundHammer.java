...
public class ItemBoundHammer extends ItemHammerSE implements ISpartanBoundWeapon {
    ...
    public ItemBoundHammer() {
        ...
        this.baseAttackDamage = Math.max(0.5F, this.materialEx.getAttackDamage() * ConfigHandler.damageMultiplierHammer + ConfigHandler.damageBaseHammer - 1.0F);
