...
public class ItemBoundSpear extends ItemSpearSE implements ISpartanBoundWeapon {
    protected final double baseAttackDamage;
    protected final double baseAttackSpeed;

    public ItemBoundSpear() {
        ...
        this.baseAttackDamage = Math.max(0.5F, this.materialEx.getAttackDamage() * ConfigHandler.damageMultiplierSpear + ConfigHandler.damageBaseSpear - 1.0F);
