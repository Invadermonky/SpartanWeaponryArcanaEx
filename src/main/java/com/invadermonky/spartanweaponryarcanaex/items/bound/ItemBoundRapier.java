...
public class ItemBoundRapier extends ItemRapierSE implements ISpartanBoundWeapon {
    ...
    public ItemBoundRapier() {
        ...
        this.baseAttackDamage = Math.max(0.5F, this.materialEx.getAttackDamage() * ConfigHandler.damageMultiplierRapier + ConfigHandler.damageBaseRapier - 1.0F);
